...
class RegistrationPagenew_newgamil extends StatefulWidget {
  final User user;
  const RegistrationPagenew_newgamil({Key? key, required this.user})
      : super(key: key);

  @override
  State<RegistrationPagenew_newgamil> createState() =>
      _RegistrationPageState(user);
}

class _RegistrationPageState extends State<RegistrationPagenew_newgamil>
  ...
  /* Future<void> registertoke() async {
    ...
    if (!kIsWeb) {
      ...
      flutterLocalNotificationsPlugin = FlutterLocalNotificationsPlugin();
      const AndroidInitializationSettings android = AndroidInitializationSettings('@drawable/favicon_2');
...
/*
  Future<void> registertoke() async {
    ...
    if (!kIsWeb) {
      ...
      final android = AndroidInitializationSettings('@drawable/favicon_2');
      ...
      builder: (context) => AlertDialog(
        ...
        actions: [
          TextButton(
            ...
            child: const Text('Open Settingsk'),
          ),
        ],
      ),
    ).then((_) {
    ...
    return Container(
      ...
      child: Center(
          child: Text.rich(TextSpan(
            ...
            TextSpan(
                text:
                    ' of the connfy #getsocialApp and confirm that I have read and accpeted the ',
                style: GoogleFonts.poppins(
...
// Method to show error messages
  ...
  doRegistration(String mobileDeviceId, String nickName, String dob, int gender,
    ...
    try {
      ...
      print("Error creating account 4: $e");
      ...
      builder: (BuildContext context) => AlertDialog(
        ...
        actions: [
          TextButton(
            ...
            child: const Text('Open Settingss'),
          ),
        ],
      ),
    );
  ...
  Future Register() async {
    try {
      ...
      print("Error creating account 5: $e");
