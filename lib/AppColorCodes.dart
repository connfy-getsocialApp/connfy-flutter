...
Color pPrimaryColor = Colors.blue;
Color pMedColor = Colors.blue.shade300;
Color pSecondaryColor = Colors.blue.shade100;
...
class _ColorChangeState extends State<ColorChange> {
        ...
        child: Container(
          ...
          children: [
            ...
            Text(
              ...
              style: TextStyle(
                  shadows: [isDark ? Shadow(color: Colors.white, offset: Offset(0, -5)) : Shadow(color: Colors.black, offset: Offset(0, -5))],
            ...
            Padding(
              ...
              child: RawMaterialButton(
                ...
                elevation: 5.0,
                constraints: BoxConstraints(minWidth: MediaQuery.of(context).size.width * 0.95, minHeight: 42.0),
                fillColor: Theme.of(context).primaryColor,
                child: Text(
                  'Continue',
                  style: isDark == true
                      ? TextStyle(color: Colors.black, fontSize: 16, letterSpacing: 4, fontWeight: FontWeight.w600)
                      : TextStyle(color: Colors.white, fontSize: 16, letterSpacing: 4, fontWeight: FontWeight.w500),
                ),
                padding: EdgeInsets.all(10.0),
  ...
  Text buildText(String color, bool isDark) {
    return Text(
      color,
      style: isDark
          ? TextStyle(color: Colors.white, fontSize: 15, letterSpacing: 4, fontWeight: FontWeight.w600)
          : TextStyle(color: Colors.black, fontSize: 15, letterSpacing: 3, fontWeight: FontWeight.w600),
    );
  }
  ...
  RoundedRectangleBorder buildRoundedRectangleBorder(bool isDark) {
    return RoundedRectangleBorder(
      ...
      side: isDark == true ? BorderSide(color: Colors.white, width: 2) : BorderSide(color: Colors.black, width: 2),
    );
  }
}
