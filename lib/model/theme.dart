...
class LightTheme extends AppTheme {
  LightTheme({
    Color flashingCircleDarkColor = const Color(0xff03A0E3),
    ...
    Color backArrowColor = const Color(0xff03A0E3),
    ...
    TextStyle linkPreviewIncomingTitleStyle = const TextStyle(),
    TextStyle linkPreviewOutgoingTitleStyle = const TextStyle(),
    Color replyTitleColor = const Color(0xff03A0E3),
    ...
    Color outgoingChatBubbleColor = const Color(0xff03A0E3),
    ...
    Color sendButtonColor = const Color(0xff03A0E3),
    ...
    Color verticalBarColor = const Color(0xff03A0E3),
