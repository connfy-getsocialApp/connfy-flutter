class City {
  ...
  static List<City> allCities()
  {
    ...
    lstOfCities.add(new City(name:"London",country: "Britain",population: "8 mill",image: "berlin.png"));
    lstOfCities.add(new City(name:"Vancouver",country: "Canada",population: "2.4 mill",image: "paris.png"));
    ...
    lstOfCities.add(new City(name:"Berlin",country: "Germany",population: "3.7 mill",image: "newyork.png"));
    return lstOfCities;
  }
}